...
$e107_paths['ADMIN_DIRECTORY']     = 'admin/';
$e107_paths['FILES_DIRECTORY']     = 'files/';
$e107_paths['IMAGES_DIRECTORY']    = 'images/';
$e107_paths['THEMES_DIRECTORY']    = 'themes/';
$e107_paths['PLUGINS_DIRECTORY']   = 'plugins/';
$e107_paths['HANDLERS_DIRECTORY']  = 'handlers/';
$e107_paths['LANGUAGES_DIRECTORY'] = 'languages/';
$e107_paths['HELP_DIRECTORY']      = 'docs/help/';
$e107_paths['DOWNLOADS_DIRECTORY'] = 'files/downloads/';
...
<head>
	...
	<style type="text/css">
		...
		body						{ background:#FFFFFF url(files/install/images/mainbg.png) repeat-x 0 0; font:12px/16px Arial,Helvetica,sans-serif; color:#656565; }
		...
		* html .clearfix			{ height:1%; }
		...
		.headerbg 					{ background:url(files/install/images/headerbg.png) repeat-x scroll 0 0 transparent; height:238px; width:100%; position:relative; z-index:10; }
		.stage-1					{ height:300px; position:relative; z-index:10; background:url(files/install/images/1.png) no-repeat 100% 0; }
		.stage-2					{ height:300px; position:relative; z-index:10; background:url(files/install/images/2.png) no-repeat 100% 0; }
		.stage-3					{ height:300px; position:relative; z-index:10; background:url(files/install/images/3.png) no-repeat 100% 0; }
		.stage-4					{ height:300px; position:relative; z-index:10; background:url(files/install/images/4.png) no-repeat 100% 0; }
		.stage-5					{ height:300px; position:relative; z-index:10; background:url(files/install/images/5.png) no-repeat 100% 0; }
		.stage-6					{ height:300px; position:relative; z-index:10; background:url(files/install/images/6.png) no-repeat 100% 0; }
		.stage-7					{ height:300px; position:relative; z-index:10; background:url(files/install/images/7.png) no-repeat 100% 0; }
		.stage-7-finished			{ height:300px; position:relative; z-index:10; background:url(files/install/images/8.png) no-repeat 100% 0; }
		...
		.main-container				{ background:#FFFFFF url(files/install/images/contentbg.png) repeat-x 0 0; margin:0 auto ; width:100%; margin:10px 0; padding:20px 0px; }
		...
		.top-content-title			{ font-size:16px; font-weight:bold; padding-bottom:10px; margin-bottom:10px; text-shadow:2px 2px 2px #CCCCCC; background:url(files/install/images/rightbox_title_bg.png) repeat-x 0 100%; }
	...
	<div class="wrapper">
		<div class="headerbg">
			<div class="stage-{stage}'.(!$this->_error && 7 == $this->template->getTag('stage') ? '-finished' : '').'">
				<div class="install-logo f-left"><img src="files/install/images/e_logo.png" alt="" /></div>
...
//		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}menus VALUES (22, 'PCMag', 3, 1, '0', '', '1')");
		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}menus VALUES (21, 'plugins', 2, 1, '0', '', '1')");
		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}menus VALUES (22, 'themes', 3, 1, '0', '', '2')");
		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}menus VALUES (23, 'handbook', 4, 1, '0', '', '3')");
