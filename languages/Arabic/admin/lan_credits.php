...
|
|     $Source: /cvsroot/e107/e107_0.7/e107_languages/Arabic/admin/lan_credits.php,v $
|     $Revision: 1.5 $
...
+----------------------------------------------------------------------------+
*/
define("PAGE_NAME", "مطوري المجلة");
define("CRELAN_1", "مطوري المجلة");
define("CRELAN_2", "هنا تجد لائحة برمجيات مستقلة مستعملة في المجلة ، فريق التطوير لمجلة يقدم الشكر الخالص للمبرمجين الذين سمحوا باستعمال برمجياتهم مع محتوى المجلة، و لإصداراتهم الخاضعة لنظام الرخصة العمومية للجميع .");
define("CRELAN_3", "جميع الحقوق محفوظة");
define("CRELAN_4", "عرض المطورين");
define("CRELAN_5", " عرض السكريبتات  المدمجة");
define("CRELAN_6", "تم تطوير المجلة من طرف ...");
define("CRELAN_7", "الإصدار");
define("CRELAN_8", "الصلاحية");
define("CRELAN_9", "الترخيص");
