...
if (!$subcheck == ""){
      ...
      $store_num_video	   = $_POST['num_video'];
...
$store_ok = "1";
      ...
      $store_num_video  = $row['disp_download'];
...
// Show SEO
$text .= "
<tr><td style='width:30%' class='forumheader3'>$seo_dislan</td>
<td style='width:70%' class='forumheader3'>";

      if ($store_seo == "0") {$sel_sd_00 = "SELECTED";}
      if ($store_seo == "1") {$sel_sd_01 = "SELECTED";}

$text .= "
<select class='tbox' name='seo' >
...
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='movie_colum' value='$store_movie_colum' size='10' maxlength='2' />";
$text .= "</td></tr>";


$text .= "
<tr><td style='width:30%' class='forumheader3'>$mr_dislan</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='movie_row' value='$store_movie_row' size='10' maxlength='2' />";
$text .= "</td></tr>";


$text .= "
<tr><td style='width:30%' class='forumheader3'>$tm_dislan</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='title_menu' value='$store_titl_menu' size='40' maxlength='100' />
</td></tr>";
...
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='num_video' value='$store_num_video' size='10' maxlength='3' />";
$text .= "</td></tr>";

$text .= "
<tr><td style='width:30%' class='forumheader3'>$mw_dislan</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='menu_width' value='$store_menu_width' size='10' maxlength='3' />";
$text .= "</td></tr>";

$text .= "
<tr><td style='width:30%' class='forumheader3'>$mh_dislan</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='menu_height' value='$store_menu_height' size='10' maxlength='3' />";
$text .= "</td></tr>";
