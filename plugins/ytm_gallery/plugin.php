...
$eplug_conffile = "admin_config_movie.php";  // use admin_ for all admin files.
...
CREATE TABLE ".MPREFIX."er_ytm_gallery (
      ...
      disp_title        TINYINT(3)   NOT NULL DEFAULT '2',
      ap_submit         TINYINT(3)   NOT NULL DEFAULT '0',
      disp_search       TINYINT(3)   NOT NULL DEFAULT '1',
	  disp_download		TINYINT(3)	 NOT NULL DEFAULT '5',
	  seo			    TINYINT(3)   NOT NULL DEFAULT '0',
...
"INSERT INTO ".MPREFIX."er_ytm_gallery (title_gallery, title_form, title_menu, title_tp, submit_class, submit_text, random_menu, movie_colum, movie_row, menu_width, menu_height, bb_class, gal_order, version, disp_title, ap_submit, disp_search,  short_title, short_title_count) VALUES ('" . LAN_YTM_PLUGIN_9 . "', '" . LAN_YTM_PLUGIN_10 . "', '" . LAN_YTM_PLUGIN_11 . "', '". LAN_YTM_PLUGIN_14 . "', '255', '" . LAN_YTM_PLUGIN_12 . "', '1', '3', '4', '180', '180', '0', '1', '$eplug_version', '2', '0', '1', '0', '20');",
"INSERT INTO ".MPREFIX."er_ytm_gallery_category (cat_name, cat_auth) VALUES ('". LAN_YTM_PLUGIN_8 . "', '0');",
"INSERT INTO ".MPREFIX."er_ytm_gallery_movies (movie_title, movie_code, movie_category, active, input_user, input_email, input_way, input_status) VALUES ('" . LAN_YTM_PLUGIN_7 . "', 'VIOAU8rDlnQ', '1', '1', '" . LAN_YTM_PLUGIN_0 . "', '" . LAN_YTM_PLUGIN_1 . "', '1', '1');");
...
"UPDATE ".MPREFIX."er_ytm_gallery SET version = '$eplug_version', title_rating = '". LAN_YTM_PLUGIN_13 . "', title_tp = '". LAN_YTM_PLUGIN_14 . "', ap_submit = '1', disp_title = '0', disp_search = '1', disp_download = '0', short_title = '0', short_title_count = '20', ytm_rate_class = '0', disp_rate = '1' WHERE id ='1';"
);
?>
