...
+----------------------------------------------------------------------------+
*/
define("EC_ADLAN_1", "أحداث التقويم");
define("EC_ADLAN_2", "إعدادات أحداث التقويم");
define("EC_INSTALL", "تثبيت أحداث التقويم");
define("EC_UNINSTALL", "إلغاء تثبيت أحداث التقويم");
define("EC_LAN_TODAY", "اليوم");
...
define("EC_LAN_0", "يناير");
define("EC_LAN_1", "فبراير");
define("EC_LAN_2", "مارس");
define("EC_LAN_3", "أبريل");
define("EC_LAN_4", "ماي");
define("EC_LAN_5", "يونيو");
define("EC_LAN_6", "يوليوز");
define("EC_LAN_7", "غشت");
define("EC_LAN_8", "شتمبر");
define("EC_LAN_9", "أكتوبر");
define("EC_LAN_10", "نونبر");
define("EC_LAN_11", "دجنبر");
...
define("EC_LAN_12", "الاثنين");
define("EC_LAN_13", "الثلاثاء");
define("EC_LAN_14", "الأربعاء");
define("EC_LAN_15", "الخميس");
define("EC_LAN_16", "الجمعة");
define("EC_LAN_17", "السبت");
define("EC_LAN_18", "الأحد");
define("EC_LAN_19", "إ");
define("EC_LAN_20", "ث");
define("EC_LAN_21", "أ");
define("EC_LAN_22", "خ");
...
define("EC_LAN_24", "س");
define("EC_LAN_25", "أ");
define("EC_LAN_26", "الأحداث هذا الشهر");
define("EC_LAN_27", "لا توجد أحداث لهذا الشهر.");
define("EC_LAN_28", "أضف حدث جديد");
define("EC_LAN_29", "When:");
define("EC_LAN_30", "التصنيف:");
define("EC_LAN_31", "بواسطة :");
define("EC_LAN_32", "المكان:");
define("EC_LAN_33", "Contact:");
define("EC_LAN_34", "الانتقال إلى");
define("EC_LAN_35", "تعديل");
define("EC_LAN_36", "حذف");
define("EC_LAN_37", "None Listed.");
define("EC_LAN_38", "غير محددة");
define("EC_LAN_39", "اضغط هنا للمزيد من المعلومات");
define("EC_LAN_40", "الشهر الحالي");
...
define("EC_LAN_66", "تعديل الحدث");
define("EC_LAN_67", "يبدأ:");
define("EC_LAN_68", "All day event:");
define("EC_LAN_69", "ينتهي:");
define("EC_LAN_70", "عنوان الحدث:");
define("EC_LAN_71", "وقت الحدث:");
define("EC_LAN_72", "تاريخ الحدث:");
define("EC_LAN_73", "ينتهي:");
define("EC_LAN_74", "عرض التصنيف");
define("EC_LAN_75", "تم  تحديث اعدادات التقويم بنجاح.");
define("EC_LAN_76", "يمكن إضافة الاحداث  من طرف:");
define("EC_LAN_77", "تحديث الإعدادات");
define("EC_LAN_78", "إعادات التقويم");
define("EC_LAN_79", "عرض التقويم");
define("EC_LAN_80", "لائحة الأحداث");
define("EC_LAN_81", "إعداد أحداث التقويم");
define("EC_LAN_82", "To activate please go to your menus screen and select the calendar_menu into one of your menu areas.");
define("EC_LAN_83", "التقويم");
define("EC_LAN_84", "من ");
define("EC_LAN_85", "إلى");
...
define("EC_LAN_90", "اختر");
define("EC_LAN_91", "Admin must define first");
define("EC_LAN_92", "عرض التصنيف");
define("EC_LAN_93", "عرض قائمة الأحداث");
define("EC_LAN_94", "أدخل حدث جديد");
define("EC_LAN_95", "اليوم");
define("EC_LAN_96", "عرض التقويم");
define("EC_LAN_97", "الكل");
...
define("EC_LAN_105", "* حقول ضرورية");
define("EC_LAN_106", "الأحداث");
...
define("EC_LAN_109", "غير قادر على حذف هذا الحدث.");
define("EC_LAN_110", "حدث رقم");
define("EC_LAN_111", "All the events on");
define("EC_LAN_112", "All the Events in");
define("EC_LAN_113", "Event form already submitted.");
define("EC_LAN_114", "الأسبوع يبدأ من :");
define("EC_LAN_115", "الأحد");
define("EC_LAN_116", "الإثنين");
define("EC_LAN_117", "Length of daynames (characters)");
define("EC_LAN_118", "Date format in calendar header:");
define("EC_LAN_119", "شهر/سنة");
define("EC_LAN_120", "سنة/شهر");
define("EC_LAN_121", "عرض التقويم");
define("EC_LAN_123", "الإنتساب");
...
define("EC_LAN_129", "تحديث");
define("EC_LAN_130", "Subscriptions updated");
define("EC_LAN_131", "رجوع");
define("EC_LAN_132", "Expand details");
define("EC_LAN_133", "[إقرأ المزيد]");
define("EC_LAN_134", "You have to provide a category name");
define("EC_LAN_135", "الحدث");
define("EC_LAN_136", "وصف التصنيف");
define("EC_LAN_137", "الأحداث القادمة");
...
define("EC_LAN_149", "شكل التاريخ غير صحيح");
...
define("EC_LAN_155", "التصنيف:");
define("EC_LAN_156", "أضف لائحة");
define("EC_LAN_157", "Layout Options:");
define("EC_LAN_158", "Output:");
define("EC_LAN_159", "عرض");
define("EC_LAN_160", "طباعة");
define("EC_LAN_161", "PDF");
define("EC_LAN_162", "طباعة الصفحة");
define("EC_LAN_163", "قائمة الحدث");
define("EC_LAN_164", "لائحة للطباعة");
define("EC_LAN_165", "العرض الافتراضي");
define("EC_LAN_166", "Tabular List no lines");
define("EC_LAN_167", "Tabular List with lines");
define("EC_LAN_168", "من:");
define("EC_LAN_169", "إلى:");
define("EC_LAN_170", "مطبوعة في:");
define("EC_LAN_171", "List including category");
define("EC_LAN_172", "تصنيفات الحدث:");
define("EC_LAN_173", "الحدث الأول يبدأ:");
define("EC_LAN_174", "اخر حدث ينتهي:");
define("EC_LAN_175", "كل الأيام");
define("EC_LAN_176", "Recurring pattern:");
define("EC_LAN_177", "إلغاء المدخلة");
define("EC_LAN_178", "قبول المدخلة");
define("EC_LAN_179", "Confirmation of multiple event entry");
define("EC_LAN_180", "المدخلات لم  يتم حفظها  - خطأ في ترقية الجداول");
define("EC_LAN_VIEWCALENDAR", "عرض التقويم");
define("EC_LAN_VIEWALLEVENTS", "عرض كل الأحداث");
define("EC_LAN_ALLEVENTS", "كل الأحداث");
define("EC_ADLAN_A10", "الإعدادات");
define("EC_ADLAN_A11", "التصنيفات");
define("EC_ADLAN_A12", "التقويم");
define("EC_ADLAN_A13", "تعديل");
define("EC_ADLAN_A14", "جديد");
define("EC_ADLAN_A15", "حذف");
define("EC_ADLAN_A16", "تأكيد");
define("EC_ADLAN_A17", "متابعة");
define("EC_ADLAN_A18", "الإجراء");
define("EC_ADLAN_A19", "إدارة التصنيفات");
define("EC_ADLAN_A20", "تصنيفات التقويم");
define("EC_ADLAN_A21", "اسم التصنيف");
define("EC_ADLAN_A23", "أضف التصنيف");
define("EC_ADLAN_A24", "تعديل التقويم");
define("EC_ADLAN_A25", "حفظ");
define("EC_ADLAN_A26", "تم اضافة التصنيف");
define("EC_ADLAN_A27", "Unable to create category");
define("EC_ADLAN_A28", "تم  حفظ  التغييرات");
define("EC_ADLAN_A29", "Unable to save changes");
define("EC_ADLAN_A30", "تم حذف التصنيف");
define("EC_ADLAN_A31", "Tick the confirm box to delete");
define("EC_ADLAN_A32", "غير قادر على حذف التصنيف");
define("EC_ADLAN_A33", "غير محدد");
define("EC_ADLAN_A34", "Calendar Administrator Class");
define("EC_ADLAN_A59", "Category is in use. Can not delete.");
define("EC_ADLAN_A80", "حق الرؤية");
...
define("EC_ADLAN_A129", "Site Time");
...
define("EC_ADLAN_A159", "إدارة الكاش");
define("EC_ADLAN_A160", "(Only relevant if cache enabled)");
define("EC_ADLAN_A161", "تفريغ كاش التقويم");
define("EC_ADLAN_A162", "تأكيد  أفراغ الكاش");
define("EC_ADLAN_A163", "تم  إفراغ الكاش");
define("EC_ADLAN_A164", "تم  التحديث بنجاح");
...
define("EC_ADLAN_A173", "الاشتراكات");
define("EC_ADLAN_A174", "لم  يتم العثور على اشتراكات");
define("EC_ADLAN_A175", "UID");
define("EC_ADLAN_A176", "اسم المستخدم");
define("EC_ADLAN_A177", "التصنيف");
define("EC_ADLAN_A178", "المشاكل");
define("EC_ADLAN_A179", "الإجراءات");
define("EC_ADLAN_A180", "حذف الاشتراك رقم");
define("EC_ADLAN_A181", "حذف فاشل للاشتراك رقم");
define("EC_ADLAN_A182", "مجموع --NUM-- مدخلة في قاعدة البيانات");
define("EC_ADLAN_A183", "Calendar Menu mouseover shows event title");
define("EC_ADLAN_A184", "يمكن ان لا تعمل مع كل المتصفحات");
define("EC_ADLAN_A185", "لا شيء");
define("EC_ADLAN_A186", "Update settings\nand send test\nemail to self");
define("EC_ADLAN_A187", "تم  ارسال بريد  تجريبي ");
define("EC_ADLAN_A188", "خطأ في إرسال البريد  التجريبي");
define("EC_ADLAN_A189", "إذا تركت الرسالة فارغة،  سيتم استخدام نص من التصنيف الافتراضي ");
...
define("EC_ADLAN_A194", "لا شيء");
define("EC_ADLAN_A195", "عرض/طباعة");
define("EC_ADLAN_A196", "عرض/طباعة/PDF");
define("EC_ADLAN_A197", "No class membership");
define("EC_ADLAN_A198", "مستخدم خاطيء");
...
define("EC_MAILOUT_SUBJECT", "Advice of calendar event");
