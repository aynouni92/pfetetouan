...
if(file_exists(e_PLUGIN.'frontpage/sliders/slider2_'.e_LANGUAGE.'.php')) 
	include_lan(e_PLUGIN.'frontpage/sliders/slider2_'.e_LANGUAGE.'.php');
else 
	include_lan(e_PLUGIN.'frontpage/sliders/slider2_English.php');

	
if (isset($_POST['frontpage_news_submit_slider2'])) {
...
// ===========================================================================
	...
	$text .= $rs->form_open("post", e_SELF."?news" ,  'frontpage_news_submit_slider2', '', 'enctype="multipart/form-data"') .
		"<tr>
		...
		<tr>
			<td class='forumheader' colspan='2' style='text-align:left; vertical-align: top;'>
				<input type='submit' class='button' name='frontpage_news_submit_slider2' value='".LAN_SAVE."' />
			</td>
		</tr>".$rs->form_close();	
// =========================================================================
