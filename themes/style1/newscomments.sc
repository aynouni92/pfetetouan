			...
			<div class='add_comment well'  >
				...
				<form id='form3' action='comment.php?comment.news.".$nid."' method='post'   onsubmit=\"return checkform(this);\"> 								
					...
					<p>
						...
						<span id='txtCaptchaDiv' style='color:#F00'>".ADD_COMMENT_CAPTCHA." :</span> 
						<input type='hidden' id='rand_num' name='rand_num' value='".$codeverify."' />".$sec_img->r_image()."
						<input type='text' id='code_verify' name='code_verify' size='15' maxlength='20' />
