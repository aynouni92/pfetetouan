...
return (isset($news_item['news_thumbnail']) && $news_item['news_thumbnail']) ? "<a href='".e_HTTP."news.php?extend.".$news_item['news_id']."'><img class='".$GLOBALS['NEWS_CSSMODE']."_image' src='".e_IMAGE_ABS."newspost_images/".$news_item['news_thumbnail']."' alt='' style='width:470px;height:313px;' /></a>" : "<a href='".e_HTTP."news.php?extend.".$news_item['news_id']."'><img class='".$GLOBALS['NEWS_CSSMODE']."_image' src='".THEME_ABS."images/no_image.png' alt='' style='width:470px;height:313px;' /></a>";
//SC_END
